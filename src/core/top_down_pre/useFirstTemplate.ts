...
export const createFirstSetColumnTemplate = (terminators: string[], nonTerminators: string[]): DataTableColumns<Pair<string, string[]>> => {
  const firstColumns: DataTableColumns<Pair<string, string[]>> = [
    {
      key: 'key',
      title: '符号',
